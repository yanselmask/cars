...
class ListingController extends Controller
{
    ...
    {
        $listing->load('user', 'make', 'makemodel', 'type', 'transmission', 'fueltype', 'engine', 'drivetype', 'exteriorcolor', 'interiorcolor', 'offertype', 'features', 'currency', 'condition');
    ...
    {
        $models = MakeModel::select('id', 'name')
            ->where('make_id', $make)
