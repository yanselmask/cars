                            ...
                            @if (config('listing.vendor_page_banner')['app_store_link'] || config('listing.vendor_page_banner')['google_play_link'])
                                <div class="ps-3" style="min-width: 145px;">
                                    @if (config('listing.vendor_page_banner')['app_store_link'])
                                        <a class="btn-market mb-3"
                                            href="{{ config('listing.vendor_page_banner')['app_store_link'] }}"
                                            role="button">
                                    ...
                                    @if (config('listing.vendor_page_banner')['google_play_link'])
                                        <a class="btn-market"
                                            href="{{ config('listing.vendor_page_banner')['google_play_link'] }}"
                                            role="button">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="110"
                                                height="30" viewBox="0 0 140 30" fill="none">
                                                <g fill="#fff">
                                                    <path
