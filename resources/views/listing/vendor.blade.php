            ...
            <aside class="col-lg-4 order-lg-1 pe-xl-4 mb-5">
                <div class="d-flex align-items-start mb-4">
                    <img class="rounded-circle" src="{{ $user->profile_photo_url }}" width="72"
                        alt="{{ $user->full_name }}">
                    <div class="ps-2">
                        <h2 class="h4 text-light mb-1">{{ $user->full_name }}</h2>
                        @if ($user->address)
                ...
                @if (config('listing.vendor_page_banner')['showed'])
                    <div class="card card-light card-body pb-0">
                        <h3 class="h4 text-light pt-1">{{ config('listing.vendor_page_banner')['title'] }}</h3>
                        <p class="text-light opacity-70 mb-4">
                            {{ config('listing.vendor_page_banner')['description'] }}
                        </p>
                        <div class="d-flex align-items-start pt-2">
                            ...
                            @endif
                            @if(config('listing.vendor_page_banner')['app_store_link'] || config('listing.vendor_page_banner')['google_play_link'])
                            <div class="ps-3" style="min-width: 145px;">
                                @if(config('listing.vendor_page_banner')['app_store_link'])
                                <a class="btn-market mb-3" href="{{config('listing.vendor_page_banner')['app_store_link']}}"
                                    role="button">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="110" height="30"
                                        viewBox="0 0 135 28" fill="#fff">
                                        <path
                                ...
                                @endif
                                <br>
                                 @if(config('listing.vendor_page_banner')['google_play_link'])
                                <a class="btn-market" href="{{config('listing.vendor_page_banner')['google_play_link']}}" role="button">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="110" height="30" viewBox="0 0 140 30" fill="none">
                                        <g fill="#fff">
                                            <path
                                            ...
                                            <path
                                                ...
                                                stroke="#454056" stroke-width=".5"></path>
                                        </g>
                                        <g opacity=".2">
                                            <mask id="A" fill="#fff">
