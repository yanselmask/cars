...
class InstallerSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        MenuItem::create([
            'title' => ['en' => 'About Finder'],
            'menu_id' => $footer2Menu->id,
            'icon' => 'heroicon-c-adjustments-horizontal',
            'is_route' => 0,
            'url' => '#',
            'new_tab' => 0,
        ...
        MenuItem::create([
            'title' => ['en' => 'Accessibility statement'],
            'menu_id' => $footerBottomMenu->id,
            'icon' => 'heroicon-c-adjustments-horizontal',
            'is_route' => 0,
            'url' => '#',
